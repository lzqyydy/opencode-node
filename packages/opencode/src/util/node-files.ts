...
/**
 * Node.js polyfill for Bun file APIs
 * Provides static methods to replace Bun.file and Bun.write
 */
export namespace NodePolyFillBun {
  /**
  ...
  export function file(filepath: string | URL): NodeBunFile {
    ...
    return {
      ...
      async write(content: string | ArrayBuffer | Uint8Array | Response): Promise<number> {
        return NodePolyFillBun.write(resolvedPath, content)
      },
