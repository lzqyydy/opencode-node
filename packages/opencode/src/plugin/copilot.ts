              ...
              async callback() {
                while (true) {
                  ...
                  if (data.error === "authorization_pending") {
                    await NodePolyFillBun.sleep(deviceData.interval * 1000 + OAUTH_POLLING_SAFETY_MARGIN_MS)
                    continue
                  }
                  ...
                  if (data.error === "slow_down") {
                    ...
                    await NodePolyFillBun.sleep(newInterval + OAUTH_POLLING_SAFETY_MARGIN_MS)
                    continue
                  }
